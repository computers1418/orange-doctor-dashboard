...
import 'package:orange_doctor_dashboard/pages/search/components/patient_card.dart';
import 'package:orange_doctor_dashboard/widgets/single_select_mini.dart';
import 'package:orange_doctor_dashboard/widgets/single_select_mini_doctor.dart';
                  ...
                  children: [
                    ...
                    const Row(
                      children: [
                        Expanded(
                          ...
                          child: Row(
                            children: [
                              ...
                              SizedBox(width: 4,),
                              Expanded(
                                child: SingleSelectMiniDoctor(items: [], label: "Doctor")),
                              SizedBox(width: 4,),
                              Expanded(
                                child: SingleSelectMini(
                                  dropdownWidth: 160,
                        ...
                        Expanded(
                          flex: 2,
                          child: SingleSelectMini(items: [], label: "Enter", invert: true,)),
                      ],
                    ),
