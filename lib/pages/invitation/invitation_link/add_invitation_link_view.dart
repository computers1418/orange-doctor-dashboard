...
class _AddInvitationLinkViewState extends State<AddInvitationLinkView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() => ic.isDataLoading.value ? const Center(child: CircularProgressIndicator(color: Colors.orange,))
        : Column(
          children: [
                    ...
                    children: [
                      ...
                      const SizedBox(height: 10,),
                                ...
                                child: GestureDetector(
                                  onTap: () {
                                    ...
                                    if(selectedBrandId.isEmpty || selectedSpecializationId.isEmpty || linkController.text.isEmpty){
                                      ...
                                      if(selectedSpecializationId.isEmpty){
                          ...
                          children: [
                            Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text("All Brands", style: CustomFonts.poppins14W600(
                                    color: Colors.white
                                  ),),
                        ...
                        Padding(
                          ...
                          child: Column(
                            children: [
                              for(int index = 0; index < ic.invitationsList.length; index++)
                                card(index),
                            ],
                          ),
                        ),
               ...
               child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Date',
                   ...
                   Text(DateFormat('dd MMM yy').format(DateTime.parse(ic.invitationsList[index]['createdAt'])),
                   style: CustomFonts.poppins12W600(
                     color:  HexColor("#222425")
                   ),),
                ],
               ...
               child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Time',
                   ...
                   Text(DateFormat('hh:mm a').format(DateTime.parse(ic.invitationsList[index]['createdAt'])),
                   style: CustomFonts.poppins12W600(
                     color:  HexColor("#222425")
                   ),),
                ],
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                 children: [
                   Text('URL',
                    ...
                    Text(ic.invitationsList[index]['link'],
                    style: CustomFonts.poppins12W600(
                      color:  HexColor("#222425")
                    ),),
                 ],
