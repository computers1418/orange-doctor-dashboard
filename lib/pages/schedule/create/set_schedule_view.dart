...
import 'package:orange_doctor_dashboard/widgets/copy_schedule_popup.dart';
                ...
                child: SingleChildScrollView(
                  child: Column(
                      children: [
                        ...
                        Padding(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                  borderRadius:
                                      BorderRadius.circular(40),
                                  image: const DecorationImage(image: AssetImage("assets/images/pattern2.png"), fit: BoxFit.fill)        
                              ),
                              child: Column(
                                              ...
                                              children: [
                                                Expanded(
                                                  child: TextField(
                                                    ...
                                                    style: CustomFonts.poppins26W800(
                                                    ...
                                                    decoration: InputDecoration(
                                                      ...
                                                      hintText: "00:00",
                                                      hintStyle: CustomFonts.poppins26W800(
                                                        color: HexColor("#201A3F").withOpacity(.3)
                                                      ),
                                                    ),
                                                ...
                                                Expanded(
                                                  child: TextField(
                                                    ...
                                                    decoration: InputDecoration(
                                                      ...
                                                      hintText: "00:00",
                                                      hintStyle: CustomFonts.poppins26W800(
                                                        color: HexColor("#201A3F").withOpacity(.1)
                                                      ),
                                                    ),
                                                    onChanged: (value) {
                                                      if(value.length == 3 && value[2] == ':'){
                                          ...
                                          Container(
                                            ...
                                            child: Column(
                                              children: [
                                                Container(height: 30, width: 30,
                                                  decoration: BoxDecoration(
                                                    color: HexColor("#FF724C").withOpacity(0.3),
                                                    shape: BoxShape.circle
                                                  ),
                                                  child: Center(
                                                    child: Text("-",
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      borderRadius:
                                          const BorderRadius.only(
                                            topLeft: Radius.circular(50), topRight: Radius.circular(35),
                                            bottomLeft: Radius.circular(17), bottomRight: Radius.circular(35) ),
                                    ),
                                    child: Center(
                                      child: Text(
                                        "SAVE",
                                        style:
                                            CustomFonts.poppins12W700(
                                                color: Colors.white),
                                      ),
                                    ),
                                  ),
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              CircleAvatar(
                                radius: 20,
                                backgroundColor: HexColor("#222425").withOpacity(0.1),
                                child: Icon(Icons.edit, color: HexColor("#222425"), size: 16,),
                              ),
                                          ...
                                          InkWell(
                                            ...
                                            child: Padding(
                                              ...
                                              child: Container(
                                                ...
                                                // height: 110,
                                                decoration: BoxDecoration(
                                                  color: selectedSchedule == i ? HexColor("#FF724C"): HexColor("#FFF7E9"),
                                                  borderRadius:
                                                  ...
                                                  children: [
                                                    Text(
                                                     ...
                                                     Text(
                                                      ...
                                                      style: CustomFonts
                                                          .poppins14W700(
                                                              color: selectedSchedule == i ? Colors.white: HexColor("#6A5633")),
                                                    ),
                                                     Text(
                                                      "-",
                                                      style: CustomFonts
                        ...
                        const CopySchedulePopup(text: "Copy previous schedule for today"),
                        const SizedBox(height: 8,),
                        const CopySchedulePopup(text: "Copy today’s schedule for other days", bottom: -420,),
                        const SizedBox(height: 16,),
                        Padding(
                          ...
                          child: Row(
                            children: [
                              Container(
                                ...
                                child: Row(
                                  children: [
                                    Icon(Icons.edit, color: HexColor("#FF724C"),
                                    size: 12,),
                                   Text(" Tap to edit",
