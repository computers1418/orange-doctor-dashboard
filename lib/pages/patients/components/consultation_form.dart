...
import 'package:orange_doctor_dashboard/pages/patients/components/problems_sheet.dart';
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text("Sms Sent", style: CustomFonts.poppins10W700(
                      color: Colors.white
                    ))
                  ],
                ),
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    const SizedBox(width: 12,),
                    Text("Email Sent", style: CustomFonts.poppins10W700(
                      color: Colors.white
                    ))
                  ],
                ),
          ...
          Row(
            children: [
              ...
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("Amount Paid", style: CustomFonts.poppins12W700(
                      color: HexColor("#201A3F").withOpacity(0.5)
                    )),
              
                  Text("Rs. 3000", style: CustomFonts.poppins24W800(
                      color: HexColor("#222425")
                    ))
                ],
              ),
                  ...
                  child: Row(
                    children: [
                      CircleAvatar(
                        ...
                        child: Icon(Icons.add, color: HexColor("#222425"), size: 18,),
                      ),
                      ...
                      Expanded(
                        child: Container(
                          alignment: Alignment.center,
                          child: Text("New Consultation", style: CustomFonts.poppins12W800(
