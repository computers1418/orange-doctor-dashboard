                                ...
                                Expanded(
                                  child: InkWell(
                                    onTap: () => setState(() {
                                      ...
                                      height: 37,
                                      decoration: BoxDecoration(
                                        color: selectedOption == 'Specialization' ?
                                        HexColor("#FF724C") : Colors.white,
                                        borderRadius: BorderRadius.circular(30)
                                      ),
                                      child: Center(
                                ...
                                Expanded(
                                  child: InkWell(
                                    onTap: () => setState(() {
                                      ...
                                      height: 37,
                                      decoration: BoxDecoration(
                                        color: selectedOption == 'Achievements' ?
                                        HexColor("#FF724C") : Colors.white,
                                        borderRadius: BorderRadius.circular(30)
                                      ),
                                      child: Center(
                            ...
                            Stack(
                              children: [
                                ...
                                Positioned(bottom: 14, right: 24,
                                  ...
                                  child: Center(child: Image.asset('assets/images/download.png'))),
                                )
                              ],
                            ),
                            const SizedBox(height: 16,),
