...
import 'package:orange_doctor_dashboard/widgets/pagination.dart';
                  ...
                  children: [
                            ...
                            child: InkWell(
                              onTap: () => setState(() {
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  HexColor("#FF724C") : HexColor("#FFF7E9"),
                                  borderRadius: BorderRadius.circular(30)
                                ),
                                child: Center(
                                  child: Text('Set Problem',
                                    style: CustomFonts.poppins16W700(
                                  color: selectedOption == 'Set Problem' ? 
                                  HexColor("#FFF7E9") : HexColor("#FF724C"),
                                  ),),
                                ),
                              ),
                            ),
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(flex: 7,
                          child: Pagination(pagesLenght: 10, callback: callback, currentPage: currentPage))
                      ],
                    ),
                    const SizedBox(height: 20,),
                    Row(
            ...
            Row(
              ...
              children: [
                Container(
                  ...
                  child: Center(
                    child: Text("$index",
                    style: CustomFonts.poppins15W600(
