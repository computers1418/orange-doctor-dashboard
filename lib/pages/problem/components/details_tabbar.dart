            ...
            children: [
              CircleAvatar(
                ...
                backgroundColor: selected==idx
                  ? HexColor("#2A2C41") : Colors.white.withOpacity(0.2),
                child: Image.asset("assets/images/problems/${icons[idx]}.png", width: 28, height: 28,),
              ),
              Text(labels[idx], style: CustomFonts.poppins10W600(
                color:  selected==idx
