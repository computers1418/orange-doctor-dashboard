...
import 'package:orange_doctor_dashboard/pages/problem/components/options.dart';
                            ...
                            children: [
                              Expanded(
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      Text("Booking Message", style: CustomFonts.poppins13W700(
                                        color: HexColor("#2A2C41")
                                      ),),
                                      Icon(Icons.keyboard_arrow_down_outlined, size: 20, color: HexColor("#2A2C41"))
                                    ],
                                  ),
                                ),
                              ),
                                  ...
                                  children: [
                                    Expanded(
                                      child: Container(
                                        ...
                                        child: Center(
                                          child: Text("Make Live", style: CustomFonts.poppins10W600(
                                            color: Colors.white
                                          ),),
                                        ),
                                      ),
                          ...
                          Container(
                              ...
                              child: Padding(
                                ...
                                child: TextField(
                                  maxLines: 5,
                                  maxLength: 100,
                                  controller: TextEditingController(text: "Treatment starting at as low as 2oo Rs. per session."),
                                  decoration: InputDecoration(
                                    contentPadding: const EdgeInsets.symmetric(
                                      horizontal: 16
                                    ),
                                    counterStyle: CustomFonts.poppins8W600(
                                            color: HexColor("#FF724C")
                                          ),
                            ...
                            child: Row(
                              children: [
                                Container(
                                  ...
                                  child: Center(
                                    child: Text("Update", style: CustomFonts.poppins8W600(
                                      color: Colors.white
                                    ),),
                                  ),
                                ),
                                ...
                                Container(
                                  ...
                                  child: Center(
                                    child: Text("Save", style: CustomFonts.poppins8W600(
                                      color: Colors.white
                                    ),),
                                  ),
                                ),
                                ...
                                Container(
                                  ...
                                  child: Center(
                                    child: Text("Undo", style: CustomFonts.poppins8W600(
                                      color: Colors.white
                                    ),),
                                  ),
                                )
                      ...
                      child: Column(
                        children: [
                          Align(
                            ...
                            child:Icon(Icons.keyboard_arrow_down_outlined, size: 20, color: HexColor("#2A2C41"))
                          ),
