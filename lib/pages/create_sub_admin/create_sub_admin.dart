...
import 'package:orange_doctor_dashboard/widgets/custom_appbar.dart';
import 'package:orange_doctor_dashboard/widgets/custom_drawer.dart';
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Stack(alignment: Alignment.topLeft,
                children: [
                Image.asset("lib/pages/create_sub_admin/assets/bg1.png",
                  fit: BoxFit.fill,),
                Image.asset("lib/pages/create_sub_admin/assets/bg2.png",
                fit: BoxFit.fill,),
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        ...
                        Container(
                          ...
                          child: Center(
                            child: Text('Username must be alphabets',
                        ...
                        Container(
                          ...
                          child: Center(
                            child: Text('Password must be at least 8 characters long and can contain alpha numeric and special characters.',
                              style: CustomFonts.poppins10W700(
                                color: Colors.white
                              ),
                            ),
