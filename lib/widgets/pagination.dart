...
class Pagination extends StatelessWidget {
  ...
  const Pagination({ Key? key, required this.pagesLenght, required this.callback, required this.currentPage }) : super(key: key);
    ...
    return Row(mainAxisAlignment: MainAxisAlignment.end,
      children: [
          ...
          InkWell(
            onTap: () => callback(i),
              ...
              padding: EdgeInsets.symmetric(
                horizontal: currentPage == i ? 3.0 : 1
                ),
              child: Container(
              padding: const EdgeInsets.all(4),
              height: 23, width: 23,
              decoration: BoxDecoration(
                shape: BoxShape.circle,
                color: currentPage == i ? HexColor("#F5F5F5") : Colors.transparent
              ),
              child: Center(child: Text("$i",
              style: CustomFonts.poppins10W700(
                color: currentPage == i ? HexColor("#222425") 
        ...
        Padding(
            ...
            child: Center(child: Text("$pagesLenght",
            style: CustomFonts.poppins10W700(
        ...
        InkWell(
          ...
          child: Container(
            ...
            color: HexColor("#FF724C").withOpacity(currentPage == pagesLenght ? .5 : 1),
            ),
          ),
        )
      ],
