                ...
                builder: (_, value, __) {
                  return ListView(
                    children: [
                      Row(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text('Copy Schedule', style: TextStyle(
                      ...
                      ...["21 Feb, Wed", "22 Feb, Wed", "23 Feb, Wed", "24 Feb, Wed", "25 Feb, Wed", "26 Feb, Wed", "27 Feb, Wed"].map((e){
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  Text("2024", style: CustomFonts.poppins8W600(
                                    color: HexColor("#FF724C")
                                    )),
                                  const SizedBox(height: 4),
                                  Text(e, style: CustomFonts.poppins14W800(
                              ...
                              CircleAvatar(
                                ...
                                backgroundColor: clicked ? HexColor("#FF724C") : HexColor("#FFE8BF"),
                                child: Icon(clicked
                                ? Icons.check
                                : Icons.add, color: clicked ? Colors.white : HexColor("#6A5633"), size: 16),
                              )
          ...
          child: Container(
            ...
            child: Row(
              children: [
                ...
                Icon(Icons.keyboard_arrow_down, color: HexColor("#6A5633"),)
              ],
            ),
          ),
        ),
