...
class SingleSelectAppointment extends StatefulWidget {
  ...
  final String label;
  final bool invert;
  const SingleSelectAppointment({super.key, required this.items, required this.label, this.invert = false});

  @override
  State<SingleSelectAppointment> createState() => _SingleSelectAppointmentState();
}
    ...
    return DropdownButtonHideUnderline(
          child: DropdownButton2(
            customButton: Container(
              ...
              child: Text(widget.label, textAlign: TextAlign.center, style: CustomFonts.poppins8W600(
                color: Colors.white
              )),
            ),
