                ...
                child: ListView(
                  children: [
                    Container(
                      ...
                      child: const Text('ALL OPTION', style: TextStyle(
                      ...
                      child: Column(
                        ...
                        children: [
                          const Row(
                            children: [
                              Expanded(
                                child: Text('INVITATION SENT', style: TextStyle(
                                  fontWeight: FontWeight.w800,
                                  color: Colors.white,
                                  fontSize: 12
                                )),
                          ...
                          const SizedBox(height: 6),
                          const Text('. All Types of Registration', style: TextStyle(
                            fontWeight: FontWeight.w600,
                            color: Colors.white,
                            fontSize: 12
                          )),
                          ...
                          const Padding(
                            padding: EdgeInsets.only(left: 24, bottom: 6),
                            child: Text('. Express Registration', style: TextStyle(
                              fontWeight: FontWeight.w600,
                              color: Colors.white,
                              fontSize: 12
                            )),  
                          ...
                          const Padding(
                            padding: EdgeInsets.only(left: 24, bottom: 6),
                            child: Text('. Partial Registration', style: TextStyle(
                              fontWeight: FontWeight.w600,
                              color: Colors.white,
                              fontSize: 12
                            )),  
                          ),
                          const Text('. Unregistered', style: TextStyle(
                            fontWeight: FontWeight.w600,
                            color: Colors.white,
                            fontSize: 12
                          )),
                          const SizedBox(height: 6),
                          const Text('. Resend 2 or more', style: TextStyle(
                            fontWeight: FontWeight.w600,
                            color: Colors.white,
                            fontSize: 12
                          )),
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Center(
                                  child: Text('Exclude Moved to APK',
                                    style: CustomFonts.poppins10W700(
                      ...
                      child: const Column(
                        ...
                        children: [
                          Row(
                            children: [
                              Expanded(
                                child: Text('APK SENT', style: TextStyle(
                                  fontWeight: FontWeight.w800,
                                  color: Colors.white,
                                  fontSize: 12
                                )),
                          ...
                          SizedBox(height: 6),
                          Text('. Moved to APK Page', style: TextStyle(
                            fontWeight: FontWeight.w600,
                            color: Colors.white,
                            fontSize: 12
                          )),
                    ...
                    Container(
                      ...
                      padding: const EdgeInsets.symmetric(vertical: 10, horizontal: 15),
                      child: const Text('DELETED INVITATION LINK', style: TextStyle(
                        fontWeight: FontWeight.w800,
                        color: Colors.white,
                        fontSize: 12
                      )),
